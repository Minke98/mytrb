...
class RequirementDetailsView extends GetView<UploadRequirementsController> {
  const RequirementDetailsView({super.key});
                  ...
                  return Column(
                    children: [
                      _buildRequirementCard(
                          ...
                          validationNote: requirement
                              .catatan, // Validation note, if available
  ...
  void _handleFileView(String? fileUrl, String fileCategory) async {
    ...
    if (fileExtension == 'jpg' ||
      ...
      Get.dialog(
        AlertDialog(
          title: Text('Kategori: $fileCategory'), // Menambahkan kategori file
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    showDialogCatatan(validationNote);
                                  },
                                  child: Container(
  ...
  void showDialogCatatan(String? catatan) {
    Get.dialog(
      AlertDialog(
        title: const Text(
          'Catatan',
