...
class CustomColors extends ThemeExtension<CustomColors> {
  ...
  CustomColors lerp(ThemeExtension<CustomColors>? other, double t) {
    ...
    return CustomColors(
      ...
      positive2Container:
          Color.lerp(positive2Container, other.positive2Container, t),
      onPositive2Container:
          Color.lerp(onPositive2Container, other.onPositive2Container, t),
      ...
      negative2Container:
          Color.lerp(negative2Container, other.negative2Container, t),
      onNegative2Container:
          Color.lerp(onNegative2Container, other.onNegative2Container, t),
      ...
      warning2Container:
          Color.lerp(warning2Container, other.warning2Container, t),
      onWarning2Container:
          Color.lerp(onWarning2Container, other.onWarning2Container, t),
    );
  }
  ...
  CustomColors harmonized(ColorScheme dynamic) {
    return copyWith(
      ...
      onPositive2Container:
          onPositive2Container!.harmonizeWith(dynamic.primary),
      ...
      onNegative2Container:
          onNegative2Container!.harmonizeWith(dynamic.primary),
